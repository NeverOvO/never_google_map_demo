...
class MapCoordinatesPage extends StatefulWidget {
  final arguments;
  const MapCoordinatesPage({Key? key, this.arguments}) : super(key: key);

  @override
  _MapCoordinatesPageState createState() => _MapCoordinatesPageState();
}

class _MapCoordinatesPageState extends State<MapCoordinatesPage> {
